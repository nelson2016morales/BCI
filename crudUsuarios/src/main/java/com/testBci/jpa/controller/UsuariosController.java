...
public class UsuariosController {
	...
	public ResponseEntity<Object> crearUsuario(@Valid @RequestBody Usuarios usuarioRequest, BindingResult bindingResult){	
		...
		if(bindingResult.hasErrors()){
			...
			if(opcionalUsuario.isPresent()) {
				...
				nuevoUsuario = usuarioServiceImpl.crearUsuario(usuarioRequest);
